...
local window = Library:CreateWindow({ Title = "DatG Hub", Desc = "1.0 [Beta]", serialkey = 111220221700 })
...
windowInstance.Main.MainScreen.JoinDiscordScreen.ButtonJoinDescription.Text = "https://discord.gg/update"
...
function AttackNoCD()
	...
	if getgenv().SupperFast or _G.Attack_Xenon or _G.Attack_Xenon2 == true then
		...
		Lop.activeController.attacking = true
		...
		Lop.activeController.hitboxMagnitude = 20
	end
end
                    ...
                    if  _G.FastAttackNormalSpeed then
                        if SeraphFrame.activeController then
                            -- if v.Humanoid.Health > 0 then
                                ...
                                SeraphFrame.activeController.hitboxMagnitude = 30
